...
import com.smjcco.wxpusher.client.sdk.demo.result.HttpException;
import com.smjcco.wxpusher.client.sdk.demo.result.Result;
import com.smjcco.wxpusher.client.sdk.demo.result.ResultCode;
import com.smjcco.wxpusher.client.sdk.demo.utils.DateUtil;
...
public class HealthCheckController {
    ...
    public Result alive() {
        ...
        com.smjcco.wxpusher.client.sdk.bean.Result<Integer> result = WxPusher.getDefaultWxPusher().queryMessageStatus(1L);
